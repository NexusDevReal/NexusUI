--[[
╔══════════════════════════════════════════════════════════════╗
║   NexusUI  v1.6 —  Roblox Luau UI Library                   ║
║   "Polish" update — every surface refined                    ║
╠══════════════════════════════════════════════════════════════╣
║  v3.5 Changes                                                ║
║  • Window spawn: scale+fade-in animation on open             ║
║  • Cards: glass top-shine + slightly deeper surface          ║
║  • Tab bar: sliding animated underline indicator             ║
║  • Sections: gradient-fade side lines, letter-spacing        ║
║  • Button: white shine overlay + ripple on press             ║
║  • Toggle: thumb size-bounce on state change                 ║
║  • Slider: track inner-glow while dragging                   ║
║  • Notifications: icon-bubble scale pulse on appear          ║
║  • Colors: richer accent, warmer surface, better contrast    ║
║  • Scrollbar: thinner + fades in/out on hover                ║
╚══════════════════════════════════════════════════════════════╝
--]]
...
-- ════════════════════════════════════════════════════════════
--  THEME  v1.6 — richer, warmer, higher contrast
-- ════════════════════════════════════════════════════════════
local T = {
	-- Window / body
...
-- ════════════════════════════════════════════════════════════
--  NOTIFICATION  (v1.6: icon-bubble scale pulse on appear)
-- ════════════════════════════════════════════════════════════
local _NH = nil
...
function NexusUI:Notify(opt)
	...
	local icLbl=MkLabel(icBox, icon, 15, accent, Enum.Font.GothamBold,
		Enum.TextXAlignment.Center, Enum.TextYAlignment.Center)
	icLbl.Size=UDim2.new(1,0,1,0); icLbl.ZIndex=203
...
function NexusUI:CreateWindow(opt)
	...
	local wSub   = opt.Subtitle or "v1.6"
	...
	-- ──────────────────────────────────────────────────────
	--  MAIN WINDOW  (v1.6: spawn animation — scale+fade in)
	-- ──────────────────────────────────────────────────────
	...
	-- ──────────────────────────────────────────────────────
	--  TITLE BAR  (v1.6: deeper gradient, brighter icon pill)
	-- ──────────────────────────────────────────────────────
	...
	-- ════════════════════════════════════════════════════════
	--  TAB BAR  (v1.6: sliding underline indicator)
	-- ════════════════════════════════════════════════════════
	...
	function WinAPI:AddTab(tabName)
		...
		-- ══════════════════════════════════════════════════
		--  BUTTON
		--  v1.6: white shine overlay on pill, ripple on press
		-- ══════════════════════════════════════════════════
		...
		-- ══════════════════════════════════════════════════
		--  TOGGLE
		--  v1.6: thumb size-bounce on toggle
		-- ══════════════════════════════════════════════════
		...
		-- ══════════════════════════════════════════════════
		--  SLIDER
		--  v1.6: track glows while dragging, knob pulse
		-- ══════════════════════════════════════════════════
